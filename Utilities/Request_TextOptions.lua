...
local function CreateTextOptionsFrame()
    ...
    local textTypeText = textOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local textAnchorText = textOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local textAnchorToText = textOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
