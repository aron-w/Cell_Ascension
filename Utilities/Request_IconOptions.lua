...
local function CreateIconOptionsFrame()
    ...
    local iconAnimationText = sharedOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local iconAnchorText = sharedOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    local iconAnchorToText = sharedOptionsFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
