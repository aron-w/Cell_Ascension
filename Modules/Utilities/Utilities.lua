...
function F.CreateUtilityList(anchor)
    ...
    local dumbFS1 = listFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    dumbFS1:SetText(L["Quick Assist"])
    local dumbFS2 = listFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
