...
local function CreateItem(index)
    ...
    b.version = b:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    b.version:SetJustifyH("LEFT")
    b.version:SetPoint("LEFT", 5, 0)

    b.text = b:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_WIDGET")
    ...
    b.del:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\delete2", {18, 18}, {"CENTER", 0, 0})
    ...
    b.rename:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\rename", {18, 18}, {"CENTER", 0, 0})
...
local function CreateBackupFrame()
    ...
    -- title
    local title = backupFrame:CreateFontString(nil, "OVERLAY", "Cell_Ascension_FONT_CLASS")
    ...
    -- close
    local closeBtn = Cell.CreateButton(backupFrame, "X", "red", {18, 18}, false, false, "Cell_Ascension_FONT_WIDGET_TITLE", "Cell_Ascension_FONT_WIDGET_TITLE_DISABLE")
    ...
    buttons[0]:SetTexture("Interface\\AddOns\\Cell_Ascension\\Media\\Icons\\create", {18, 18}, {"LEFT", 2, 0})
